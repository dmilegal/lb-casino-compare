...
class LB_CC {
	...
	private function load_dependencies() {
		...
		/**
		 * The class responsible for collecting compare data.
		 */
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_footer', $plugin_public, 'show_bar' );
		$this->loader->add_action( 'wp_footer', $plugin_public, 'show_compare_modal_tpl' );
	}
