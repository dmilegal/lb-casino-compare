...
if ( ! class_exists( 'LB_CC_Template_Loader' ) ) {
	 ...
	 *
	 * @package LB_CC_Template_Loader
	 */
	class LB_CC_Template_Loader {
		/**
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'lb-cc-templates';
		 ...
		 * @var string
		 */
		protected $plugin_directory = LB_CC_DIRNAME;
        ...
        public static function load() {
            return new LB_CC_Template_Loader;
        }
