...
<button data-id="<?= $id ?>" class="lb-cc-toggle-btn lb-cc-toggle-btn--inline lb-cc-toggle-btn--add<?= !in_array($id, $cc_ids) ? ' lb-cc-toggle-btn--active' : '' ?>">
    <img width="15" height="15" src="<?= plugin_dir_url( dirname(__FILE__) ) . '/images/compare_arrows.svg' ?>">
    <span><?= $title_add ?></span>
</button>
<button data-id="<?= $id ?>" class="lb-cc-toggle-btn lb-cc-toggle-btn--inline lb-cc-toggle-btn--remove<?= in_array($id, $cc_ids) ? ' lb-cc-toggle-btn--active' : '' ?>">
    <img width="15" height="15" src="<?= plugin_dir_url(  dirname(__FILE__) ) . '/images/close.svg' ?>">
